...
globs <-
c(".","...", "<<-", "andc1", "andc2", "andc3", "andc4","alt", "aov", "be_main1", "be_main2",
"biber_base", "biber_mean", "biber_sd", "by", "bypassives1", "bypassives2",
"bypassives3", "case","change_to","closest_text_type", "conjuncts1","conjuncts2", "conjuncts3","conjuncts4",
"conjuncts5" ,"conjuncts6", "conjuncts7","conjuncts8", "conjuncts9",
"conjuncts10","conjuncts11", "corpus", "conc", "data", "dem_pronouns1", "dem_pronouns2",
"demonstratives", "detail", "dimension", "dimension_tags", "dimension_scores" , "disc_part", "doc_id",
"docvar2", "dot", "dscore", "emphatics1", "emphatics2", "emphatics3",
...
"missing2", "model", "name", "non_ascii", "null2", "null3",
...
"pro_do", "replace_vec", "right", "sentence_rels", "separate", "sh", "split_aux1", "suggestions",
